...
/**
 * @brief A helper functin for parse_newick() function to split part of the string into node name and rate.
 * 
 * @param current_string String passed from the parse_newick() function that has the information about Node name and incoming number of changes.
 * @param name Reference to name in the parse_newick() function which stores name of the current node.
 * @param rate Reference to numnber of changes in the parse_newick() function which stores incoming number of changes of current node.
 * @param separator Separator that separated name and rate in a phylogenetic tree in newick format, by default it's ":"
 */
...
/**
 * @brief Calculates the sum of number of changes in all the edges in a subtree rooted at a given node.
 * 
 * @param node Pointer to a Node whose subtree rooted in that node is our subtree of interest.
 * @param partition_set TODO
 * @param i A variable to keep track of the initial call to a recursive function unique.
 * @return Sum of number of changes in all the edges in a subtree rooted at a given node.
 */
...
/**
 * @brief Calcultaes the total number of edges in a subtree rooted at a given node.
 * 
 * @param node Pointer to a Node whose subtree rooted in that node is our subtree of interest.
 * @param partition_set TODO
 * @param i A variable to keep track of the initial call to a recursive function unique.
 * @return The total number of edges in a subtree rooted at a given node.
 */
...
/**
 * @brief Calculates the logarithmic value of the poission distribution for a given value of data and the average value of the data set.
 * 
 * @param x Indivial value from the given data set.
 * @param lambdahat Average value of the given data set.
 * @return Logarithmic value of the poission distribution for a given value of data and the average value of the data set.
 */
...
/**
 * @brief Calculates the AIC value for a given partition set from the phylogenetic tree.
 * 
 * @param combination Reference to a vector of Node pointers forming a unique partition of the tree.
 * @return double 
 */
...
vector<string> forwardAlgorithm_aic(string newick_string) {
    ...
    cout << setprecision(10) << "Total time elapsed running Forward Algorithm for AIC is: " << (time_elapsed.count())/60 << " seconds." << endl;
    cout << "" << endl;
...
vector<string> forwardAlgorithm_bic(string newick_string) {
    ...
    const auto end = chrono::steady_clock::now();
    const chrono::duration<double> time_elapsed = end - start;
    cout << setprecision(10) << "Total time elapsed running Forward Algorithm for BIC is: " << (time_elapsed.count())/60 << " seconds." << endl;
    cout << "" << endl;
...
vector<string> backwardAlgorithm_aic(string newick_string) {
    ...
    const auto end = chrono::steady_clock::now();
    const chrono::duration<double> time_elapsed = end - start;
    cout << setprecision(10) << "Total time elapsed running Backward Algorithm for AIC is: " << (time_elapsed.count())/60 << " seconds." << endl;
    cout << "" << endl;
...
vector<string> backwardAlgorithm_bic(string newick_string) {
    ...
    const auto end = chrono::steady_clock::now();
    const chrono::duration<double> time_elapsed = end - start;
    cout << setprecision(10) << "Total time elapsed running Backward Algorithm for BIC is: " << (time_elapsed.count())/60 << " seconds." << endl;
    cout << "" << endl;
...
vector<string> bruteForceAlgorithm_aic(string newick_string) {
    ...
    const chrono::duration<double> time_elapsed = end - start;
    cout << setprecision(10) << "Total time elapsed running Bruteforce Algorithm for AIC is: " << (time_elapsed.count())/60 << " seconds." << endl;
    cout << "" << endl;
...
vector<string> bruteForceAlgorithm_bic(string newick_string) {
    ...
    const chrono::duration<double> time_elapsed = end - start;
    cout << setprecision(10) << "Total time elapsed running Bruteforce Algorithm for BIC is: " << (time_elapsed.count())/60 << " seconds." << endl;
    cout << "" << endl;
...
vector<string> forwardParameterAlgorithm_aic(string newick_string, int brute_count) {
    ...
    const chrono::duration<double> time_elapsed = end - start;
    cout << setprecision(10) << "Total time elapsed running Forward with Parameter Algorithm for AIC is: " << (time_elapsed.count())/60 << " seconds." << endl;
    cout << "" << endl;
...
vector<string> forwardParameterAlgorithm_bic(string newick_string, int brute_count) {
    ...
    const chrono::duration<double> time_elapsed = end - start;
    cout << setprecision(10) << "Total time elapsed running Forward with Parameter Algorithm for BIC is: " << (time_elapsed.count())/60 << " seconds." << endl;
    cout << "" << endl;
...
vector<string> backwardParameterAlgorithm_aic(string newick_string, int brute_count) {
    ...
    const chrono::duration<double> time_elapsed = end - start;
    cout << setprecision(10) << "Total time elapsed running Backward with Parameter Algorithm for AIC is: " << (time_elapsed.count())/60 << " seconds." << endl;
    cout << "" << endl;
...
vector<string> backwardParameterAlgorithm_bic(string newick_string, int brute_count) {
    ...
    const chrono::duration<double> time_elapsed = end - start;
    cout << setprecision(10) << "Total time elapsed running Backward with Parameter Algorithm for BIC is: " << (time_elapsed.count())/60 << " seconds." << endl;
    cout << "" << endl;
...
int main() {
    string newick_string = "(((1:0,2:2)48:1,((((((3:2,4:1)54:0,5:1)53:0,(6:2,7:2)55:0)52:0,((8:1,9:1)57:1,(10:1,(11:67,12:26)59:1)58:2)56:2)51:0,((13:0,14:0)61:1,(15:0,16:0)62:2)60:1)50:1,((((17:0,18:1)66:1,(19:116,((20:110,21:118)69:105,22:136)68:130)67:106)65:1,23:1)64:0,((24:2,(25:0,26:1)72:2)71:0,27:4)70:0)63:2)49:0)47:0,((28:2,(29:0,30:1)75:0)74:2,(((31:0,(((32:0,(33:1,34:1)82:0)81:1,(35:1,36:0)83:1)80:1,(37:2,38:1)84:0)79:2)78:2,((39:59,40:1)86:1,(41:1,42:0)87:2)85:3)77:0,(43:0,(44:2,45:1)89:0)88:1)76:0)73:0)46;";
    // newick_string = "(((1:13,(2:2,3:3)49:3)48:3,((4:2,(5:6,6:4)52:5)51:1,((7:4,8:3)54:3,(((9:4,10:4)57:4,(11:1,(12:3,(13:3,14:2)60:4)59:3)58:3)56:2,15:5)55:4)53:2)50:3)47:2,(((((((16:2,17:3)67:4,18:2)66:6,(19:0,((20:3,21:3)70:0,22:6)69:2)68:1)65:5,23:3)64:1,((24:1,25:2)72:2,26:4)71:3)63:5,(((27:2,(28:2,29:2)76:0)75:1,30:4)74:3,((31:1,(32:3,(33:2,34:1)80:4)79:2)78:5,35:3)77:2)73:2)62:0,((((36:1,37:0)84:0,38:0)83:2,(39:2,40:3)85:2)82:1,((41:2,(42:2,43:4)88:3)87:3,(44:1,45:3)89:1)86:1)81:1)61:2)46;";

    // forwardAlgorithm_bic(newick_string);
    // forwardParameterAlgorithm_bic(newick_string, 2);
    // backwardAlgorithm_bic(newick_string);
    // backwardParameterAlgorithm_bic(newick_string, 2);
    // bruteForceAlgorithm_aic(newick_string);
    // bruteForceAlgorithm_bic(newick_string);
    // forwardAlgorithm_aic(newick_string);
    // forwardParameterAlgorithm_aic(newick_string, 2);
    backwardAlgorithm_aic(newick_string);
    backwardParameterAlgorithm_aic(newick_string, 2);
